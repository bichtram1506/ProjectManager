      ...
      {editClassId && (
        <Modal isOpen={isEditModalOpen} onRequestClose={closeEditModal}>
          <div className="modal-content">
            ...
            <div className="form-group">
            <label htmlFor="classCode">Mã:</label>
            <input
              type="text"
              id="classCode"
              value={editClassCode}
          ...
          <div className="form-group">
            <label htmlFor="classSpecialization">Chuyên ngành:</label>
            <select
          ...
          <div className="form-group">
            <label htmlFor="classTrainingSystem">Hệ đào tạo:</label>
            <select
          ...
          <div className="form-group">
            <label htmlFor="classAcademicYear">Niên khóa:</label>
            <select
